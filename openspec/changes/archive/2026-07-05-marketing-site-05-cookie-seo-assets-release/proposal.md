...
**Out of scope:** Google Maps consent gating (Phase 5), dynamic sitemap event entries (Phase 4), Sentry/analytics/Search Console, auth, database, Stripe.
...
- **Downstream:** Phase 2 auth follows; Phase 4 extends sitemap with event URLs; Phase 5 wires Maps embed behind consent check.
