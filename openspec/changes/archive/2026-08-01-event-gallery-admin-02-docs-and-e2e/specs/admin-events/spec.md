...
- **THEN** it includes scenarios for multi-upload add, SSR remove confirm (single and/or multi), capacity enforcement, and Events list/edit gallery entry aligned to `/admin/events/:id/gallery*`
