...
Server-side onboarding domain for the four-step member preference wizard. Phase 3 step 01 covers `@unveiled/auth` helpers only; routes, middleware, and UI ship in later steps.
