...
| `static-pages.feature` | Regular membership landing | `e2e/specs/static-pages.spec.ts` · `Scenario: Regular membership landing` | `pass` | 29 € / month plan card; no founding 19 € deposit |
| `static-pages.feature` | Bare /regular redirects to localized regular landing | `e2e/specs/static-pages.spec.ts` · `Scenario: Bare /regular redirects to localized regular landing` | `pass` |  |
