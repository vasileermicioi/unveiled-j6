...
Feature: Member Profile
  ...
  Scenario: Edit cultural preferences ("Vibes")
    When I update my interests (including Other + free text), moods, location zip under Germany/Berlin, timing, preferred days, languages (searchable list), or accessibility needs
