...
import type { LegacyLandingContent } from "../../lib/content/landing.legacy";
import type { Locale } from "../../lib/locale";
import { localizedPath } from "../../lib/locale";

type LandingPageLegacyProps = {
  locale: Locale;
  landing: LegacyLandingContent;
};

const BENEFIT_ICONS = [Hourglass, Link2, Users] as const;

/** Archived v1 guest home — phone mockup + 29€ plan + benefits strip. */
export function LandingPageLegacy({ locale, landing }: LandingPageLegacyProps) {
