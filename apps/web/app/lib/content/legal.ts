      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Ungenutzte Credits werden in den nächsten Abrechnungszeitraum übertragen, bis zu 2 Monatskontingente (max. 34 Credits).",
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Unused credits roll over to the next billing period, up to 2 months’ worth (max. 34 credits).",
