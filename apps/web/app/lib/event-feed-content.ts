...
const copyByLocale: Record<Locale, EventFeedCopy> = {
  ...
  en: {
    ...
    reset: "RESET",
    apply: "Apply",
    noResults: "NO EXPERIENCES MATCH THESE FILTERS.",
    allCategories: "All categories",
    allPartners: "All partners",
    dateRangeLabel: (from, to) => (from === to ? `Range: ${from}` : `Range: ${from} – ${to}`),
    upcomingScopeLabel: "All upcoming experiences",
    viewTabsLabel: "View",
    listView: "List",
    mapView: "Map",
    subscriptionGateTitle: "Membership required",
    subscriptionGateBody:
      "Activate your subscription to unlock experiences. You can keep browsing in the meantime.",
